  ...
  <div>
    <div class="gmapContainer">
      <GmapMap ref="mapRef" class="gmap" :center="centre" :zoom="zoom" :options="mapOptions" @dragstart="center(0)">
        <GmapMarker :position="myMarker.pos" :clickable="true" :draggable="false" @click="center(-1)" />
        <GmapCircle v-if="centered && !!activeMarkerIdx" :center="circleCenter" :radius="circleRadius" :options="circleOptions" />
    ...
    <div v-if="map">
      ...
      <div class="fixd t r ma-2 inline-children">
        <div style="min-width: 150px">
          <div v-if="activeMarkerIdx !== -1" class="my-2">
      ...
      <div v-if="devMode" class="dev fixd b l mb-3 ml-1">
...
export default {
  ...
  mounted() {
    ...
    this.markerPullInterval = setInterval(
      () =>
        this.rpc.getOthersPublicData().then(markers => {
  ...
  methods: {
    newPosition(evt) {
      ...
      this.rpc.addPublicPoint(this.myMarker);
    },
    center(markerIdx) {
